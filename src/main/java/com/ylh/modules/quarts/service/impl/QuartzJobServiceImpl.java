package com.ylh.modules.quarts.service.impl;

import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.ylh.common.constant.CommonConstant;
import com.ylh.common.exception.JeecgBootException;
import com.ylh.common.utils.DateUtils;
import com.ylh.modules.quarts.entity.QuartzJob;
import com.ylh.modules.quarts.mapper.QuartzJobMapper;
import com.ylh.modules.quarts.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	public boolean saveAndScheduleJob(QuartzJob quartzJob) {
		...
		return quartzJobMapper.save(quartzJob);
...
//			JobDetail jobDetail = JobBuilder.newJob(getClass(jobClassName).getClass()).withIdentity(jobClassName).usingJobData("parameter", parameter).build();
			JobDetail jobDetail = JobBuilder.newJob(getClass(jobClassName).getClass()).withIdentity("job02").usingJobData("parameter", parameter).build();
...
//			CronTrigger trigger = TriggerBuilder.newTrigger().withIdentity(jobClassName).withSchedule(scheduleBuilder).build();
			CronTrigger trigger = TriggerBuilder.newTrigger().withIdentity("trigger02").withSchedule(scheduleBuilder).build();
